...
# 动态导入 tools.py 模块（确保相对导入基于 StoryMaster.agent 包）
parent_package = __package__.rsplit(".", 1)[0] if __package__ else ""
module_name = f"{parent_package}._tools_impl" if parent_package else "_tools_impl"
